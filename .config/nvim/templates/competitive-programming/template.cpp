...
#define query                                                                  \
  cin >> QUERY;                                                                \
  while (QUERY--)
#define inputarr(arr, am)                                                      \
  int arr[am];                                                                 \
  fors(num, arr) cin >> num;
#define inputvec(vec, am)                                                      \
  vector<int> vec(am);                                                         \
  fors(num, vec) cin >> num;
#define input(var)                                                             \
  int var;                                                                     \
  cin >> var;
#define input2(a, b)                                                           \
...
#define inputs(var)                                                            \
  string var;                                                                  \
  cin >> var;
template <typename T> void printRec(const T &t) { std::cout << t << "\n"; }
...
#define printarr(arr)                                                          \
  fors(num, arr) { cout << num << " "; };                                      \
  cout << endl;
#define printmap(hashmap)                                                      \
