...
local api_key = "DUNNO BRUH"

local secrets_file = io.open(os.getenv("HOME") .. "/.config/mpv/secrets.lua","r")
--
if secrets_file then
	dofile(os.getenv("HOME") .. "/.config/mpv/secrets.lua")
	api_key=open_subtitles_api_key
	secrets_file:close()
end
